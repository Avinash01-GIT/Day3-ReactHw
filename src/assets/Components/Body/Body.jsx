import therapistImage from '../../Images/therapist.jpg';
  ...
  return(
    <div className={classes.main}>
      ...
      <div className={classes.texts}>
        ...
        <p>we welcome you to come explore all the benefits you'll enjoy as one of our valued guests. Our professional staff is commited to offering the best massage therapy in Mainland.</p>
      </div>
